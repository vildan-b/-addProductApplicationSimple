 ...
 <div class="row">
      <div class="card offset-2 col-md-3">
        <div class="card-body tex-center d-flex align-items-center flex-column">
          ...
          <button class="btn btn-outline-secondary " type="button" @click="$refs.file.click()">Image choose</button>
        </div>
      </div>
      <div class="col-md-5">
        <div class="col-md-11 card">
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" v-model="product.title" class="form-control" placeholder="Enter the Product Name">
            </div>
            <div class="row">
              <div class="form-group col-md-6">
                <label>Product count</label>
                <input type="text" v-model="product.count" class="form-control" placeholder="Enter the number of products">
              </div>
              <div class="form-group col-md-6">
                <label>Product price</label>
                <input type="text" v-model="product.price" class="form-control" placeholder="Enter the product price">
              </div>
            </div>
